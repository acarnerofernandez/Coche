...
public class View {
     ...
     * el usuario decide pulsar la opción de salir (5).
     */
    ...
    public void muestraCoche(Coche c) {
        if (c != null) {
            System.out.println("[VISTA] Datos del coche -> Modelo: " + c.modelo + " | Matrícula: " + c.matricula + " | Velocidad: " + c.velocidad + "km/hr");
        } else {
